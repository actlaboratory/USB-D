	...
	def build(self, package_path, build_filename):
		...
		if os.path.isdir("public"):
			...
			for public_file in os.listdir("public"):
				shutil.copyfile(os.path.join("public", public_file), os.path.join(package_path, public_file))
		ret = self.runcmd("scons")
		addon_filename = "%s-%s.nvda-addon" % (buildVars.ADDON_NAME, buildVars.ADDON_VERSION,)
		shutil.copyfile(addon_filename, os.path.join(package_path, addon_filename))
